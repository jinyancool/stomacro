...
srat <- subset(srat, subset = !is.na(cell_type) & !is.na(`Diff. level`))
...
ggsave(glue("{fig_dir}/xenium_dotplot_markers_epi_1.pdf"), p, width = 16, height = 8)
ggsave(glue("{fig_dir}/xenium_dotplot_markers_epi_1.png"), p, width = 16, height = 8)
...
![](images/xenium_image_insitu_F6_macro.png){.align-center .lightbox width="900px" 
...
![](images/xenium_image_insitu_F6_macro_supply.png){.align-center .lightbox width="900px" 
...
![](images/xenium_image_insitu_F6_epi_supply.png){.align-center .lightbox width="900px" 
...
![](images/xenium_colocal_heatmap_col_matrix_total.png){.align-center .lightbox width="900px" 
...
p1 <- ggplot(pt_mpg, aes(x = .data[["sample_id"]], fill = .data[["subtype"]])) +
  ...
  scale_y_continuous(labels = scales::label_number(accuracy = 0.01)) + 
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5))
ggsave(glue("{fig_dir}/xenium_in_out_zone_macrophage_subtype_stack_bar_sampleid.pdf"), p1, width = 8, height = 4)
ggsave(glue("{fig_dir}/xenium_in_out_zone_macrophage_subtype_stack_bar_sampleid.png"), p1, width = 8, height = 4)
p2 <- ggplot(pt_mpg, aes(Region, fill = subtype)) +
  ...
  scale_y_continuous(labels = scales::label_number(accuracy = 0.01)) + 
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5))
ggsave(glue("{fig_dir}/xenium_in_out_zone_macrophage_subtype_stack_bar_region.pdf"), p2, width = 10, height = 8)
ggsave(glue("{fig_dir}/xenium_in_out_zone_macrophage_subtype_stack_bar_region.png"), p2, width = 10, height = 8)
p3 <- ggplot(pt_celltype, aes(x = .data[["sample_id"]], fill = .data[["cell_type"]])) +
  ...
  scale_y_continuous(labels = scales::label_number(accuracy = 0.01)) + 
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5))
ggsave(glue("{fig_dir}/xenium_in_out_zone_celltype_stack_bar_sampleid.pdf"), p3, width = 7, height = 4)
ggsave(glue("{fig_dir}/xenium_in_out_zone_celltype_stack_bar_sampleid.png"), p3, width = 7, height = 4)
...
p6 <- ggplot(pt_epi, aes(x = .data[["sample_id"]], fill = .data[["cell_type"]])) +
  ...
  scale_y_continuous(labels = scales::label_number(accuracy = 0.01)) + 
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5))
ggsave(glue("{fig_dir}/xenium_in_out_zone_Epithelial_subtype_stack_bar_sampleid.pdf"), p3, width = 7, height = 4)
ggsave(glue("{fig_dir}/xenium_in_out_zone_Epithelial_subtype_stack_bar_sampleid.png"), p3, width = 7, height = 4)
...
![](images/xenium_with_wout_granuloma_celltype_stack_bar_sample.png){.align-center .lightbox width="900px" 
										fig_alt="Percentage of celltype in granuloma sample versus non-granuloma sample" 
                    fig-cap="Figure: Percentage of celltype in granuloma sample versus non-granuloma sample"}
![](images/xenium_with_wout_granuloma_macrophage_subtype_stack_bar_sample.png){.align-center .lightbox width="900px" 
...
![](images/xenium_with_wout_granuloma_epithelial_subtype_stack_bar_sample.png){.align-center .lightbox width="900px" 
...
for (subumap in subumaps){
  ...
  p <- ggplot(df, aes(x=UMAP1, y=UMAP2, color=cell_type)) +
          geom_point_rast(size = 0.8, alpha = 0.7) +
