...
p <- DotPlot(srat, features=list_markers, group.by="Macrophage.1.subtype", idents = "Macrophage") + 
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5)) +
  scale_color_gradientn(colors = config_list$scale_7)
ggsave(glue("{fig_dir}/xenium_dotplot_markers_macro_function_all.pdf"), p, width = 10, height = 5)
ggsave(glue("{fig_dir}/xenium_dotplot_markers_macro_function_all.png"), p, width = 10, height = 5)
...
select_epi_subtypes <- c("basal_cell", "basal_proliferating", 
                          "spinous_CD8A+", "spinous_1", "spinous_mix", "basal_proliferating_invasive")
...
![](images/xenium_boxplot_subtypePercent_Epithelial_tumor_by_diff_level_basal_cell.png){.align-center .lightbox width="900px" 
										fig_alt="boxplot of Epithelial subtype basal_cell difference in diff_level" 
										fig-cap="Figure: boxplot of Epithelial subtype basal_cell difference in diff_level"}
...
![](images/xenium_image_insitu_R14_macro.png){.align-center .lightbox width="900px" 
										fig_alt="in situ image plot of macrophage subtype" 
                    fig-cap="Figure: in situ image plot of macrophage subtype"}
![](images/xenium_image_insitu_R14_epi.png){.align-center .lightbox width="900px" 
										fig_alt="in situ image plot of epithelial subtype" 
                    fig-cap="Figure: in situ image plot of epithelial subtype"}
![](images/xenium_image_insitu_R14_macro_supply.png){.align-center .lightbox width="900px" 
										fig_alt="in situ image plot of macrophage subtype with other celltype" 
                    fig-cap="Figure: in situ image plot of macrophage subtype with other celltype"}
![](images/xenium_image_insitu_R14_epi_supply.png){.align-center .lightbox width="900px" 
										fig_alt="in situ image plot of epithelial subtype with other celltype" 
                    fig-cap="Figure: in situ image plot of epithelial subtype with other celltype"}
...
p1 <- ggplot(pt_epi, aes(x = .data[["sample_id"]], fill = .data[["subtype"]])) +
  ...
  facet_grid(~ .data[["Group"]], scales = "free_x", space = "free_x") +
  scale_fill_manual(values = config_list$cell_type) +
  theme_classic() +
  labs(y = "Proportion", x = "samples", fill = "Epithelial.subtype") +
  scale_y_continuous(labels = scales::label_number(accuracy = 0.01)) + 
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5))
ggsave(glue("{fig_dir}/xenium_with_wout_granuloma_epithelial_subtype_stack_bar_sampleid.pdf"), p1, width = 9, height = 4)
ggsave(glue("{fig_dir}/xenium_with_wout_granuloma_epithelial_subtype_stack_bar_sampleid.png"), p1, width = 9, height = 4)
p2 <- ggplot(pt_epi, aes(Group, fill = subtype)) +
  geom_bar(position = "fill", width = 0.6) +
  scale_fill_manual(values = config_list$cell_type) +
  theme_classic()+
  scale_y_continuous(labels = scales::label_number(accuracy = 0.01)) + 
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5))
ggsave(glue("{fig_dir}/xenium_with_wout_granuloma_epithelial_subtype_stack_bar_sample.pdf"), p2, width = 5, height = 4)
ggsave(glue("{fig_dir}/xenium_with_wout_granuloma_epithelial_subtype_stack_bar_sample.png"), p2, width = 5, height = 4)
p3 <- ggplot(pt_celltype, aes(x = .data[["sample_id"]], fill = .data[["cell_type"]])) +
  geom_bar(position = "fill", width = 0.6) +
  facet_grid(~ .data[["Group"]], scales = "free_x", space = "free_x") +
  scale_fill_manual(values = config_list$cell_type) +
  ...
  scale_y_continuous(labels = scales::label_number(accuracy = 0.01)) + 
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5))
ggsave(glue("{fig_dir}/xenium_with_wout_granuloma_celltype_stack_bar_sampleid.pdf"), p3, width = 8, height = 4)
ggsave(glue("{fig_dir}/xenium_with_wout_granuloma_celltype_stack_bar_sampleid.png"), p3, width = 8, height = 4)
p4 <- ggplot(pt_celltype, aes(Group, fill = cell_type)) +
  geom_bar(position = "fill", width = 0.6) +
  scale_fill_manual(values = config_list$cell_type) +
  theme_classic() +
  scale_y_continuous(labels = scales::label_number(accuracy = 0.01)) + 
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5))
ggsave(glue("{fig_dir}/xenium_with_wout_granuloma_celltype_stack_bar_sample.pdf"), p4, width = 4, height = 4)
ggsave(glue("{fig_dir}/xenium_with_wout_granuloma_celltype_stack_bar_sample.png"), p4, width = 4, height = 4)
p5 <- ggplot(pt_mpg, aes(Group, fill = subtype)) +
  geom_bar(position = "fill", width = 0.6) +
  scale_fill_manual(values = config_list$cell_type) +
  theme_classic() +
  scale_y_continuous(labels = scales::label_number(accuracy = 0.01)) + 
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5))
ggsave(glue("{fig_dir}/xenium_with_wout_granuloma_macrophage_subtype_stack_bar_sample.pdf"), p5, width = 4, height = 4)
ggsave(glue("{fig_dir}/xenium_with_wout_granuloma_macrophage_subtype_stack_bar_sample.png"), p5, width = 4, height = 4)
p6 <- ggplot(pt_mpg, aes(x = .data[["sample_id"]], fill = .data[["subtype"]])) +
  geom_bar(position = "fill", width = 0.7) +
  facet_grid(~ .data[["Group"]], scales = "free_x", space = "free_x") +
  scale_fill_manual(values = config_list$cell_type) +
  theme_classic() +
  ...
  scale_y_continuous(labels = scales::label_number(accuracy = 0.01)) + 
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5))
ggsave(glue("{fig_dir}/xenium_with_wout_granuloma_macrophage_subtype_stack_bar_sampleid.pdf"), p6, width = 8, height = 4)
ggsave(glue("{fig_dir}/xenium_with_wout_granuloma_macrophage_subtype_stack_bar_sampleid.png"), p6, width = 8, height = 4)
...
p1 <- pheatmap(sender, scale = "row", 
  color = config_list$scale_7, border_color = "white",
  cluster_rows = TRUE, cluster_cols = FALSE, treeheight_row = 15, treeheight_col = 0,
  show_rownames = TRUE, show_colnames = TRUE,
  fontsize_row = 10, fontsize_col = 10, angle_col = "90", main = "CCC")

pdf(glue("{fig_dir}/xenium_ccc_heatmaps_cc_mean_source.pdf"), width = 8, height = 7)
print(p1)
dev.off()
png(glue("{fig_dir}/xenium_ccc_heatmaps_cc_mean_source.png"), width = 8, height = 7, units = "in", res = 300)
print(p1)
dev.off()
...
```
![](images/xenium_ccc_heatmaps_cc_mean_source.png){.align-center .lightbox width="900px" 
										fig_alt="heatmap of cell-cell communication of stemness or differentiation as source with other cell types" 
										fig-cap="Figure: heatmap of cell-cell communication of stemness or differentiation as source with other cell types"}
...
## xenium CCC of MMP and MGC/TAM Macrophage
```{r echo=TRUE, eval=FALSE}
df_heat_cp_wide <- readRDS(glue("{rds_dir}/xenium_CCC_erosion_macrophage_plot.rds"))
#df_heat_cp_wide <- readRDS(glue("{rds_dir}/xenium_CCC_erosion_macrophage_onlyMMP9_plot.rds"))
...
pdf(glue("{fig_dir}/xenium_ccc_heatmaps_cc_mean_source_erosion_macrophage.pdf"), width = 12, height = 6)
#pdf(glue("{fig_dir}/xenium_ccc_heatmaps_cc_mean_source_erosion_macrophage_onlyMMP9.pdf"), width = 12, height = 6)
print(p1)
dev.off()
png(glue("{fig_dir}/xenium_ccc_heatmaps_cc_mean_source_erosion_macrophage.png"), width = 12, height = 6, units = "in", res = 300)
#png(glue("{fig_dir}/xenium_ccc_heatmaps_cc_mean_source_erosion_macrophage_onlyMMP9.png"), width = 12, height = 6, units = "in", res = 300)
print(p1)
dev.off()
...
pdf(glue("{fig_dir}/xenium_ccc_heatmaps_cc_mean_target_erosion_macrophage.pdf"), width = 12, height = 5)
#pdf(glue("{fig_dir}/xenium_ccc_heatmaps_cc_mean_target_erosion_macrophage_onlyMMP9.pdf"), width = 12, height = 5)
print(p2)
dev.off()
png(glue("{fig_dir}/xenium_ccc_heatmaps_cc_mean_target_erosion_macrophage.png"), width = 12, height = 5, units = "in", res = 300)
#png(glue("{fig_dir}/xenium_ccc_heatmaps_cc_mean_target_erosion_macrophage_onlyMMP9.png"), width = 12, height = 5, units = "in", res = 300)
print(p2)
dev.off()

```
![](images/xenium_ccc_heatmaps_cc_mean_source_erosion_macrophage.png){.align-center .lightbox width="900px" 
										fig_alt="heatmap of cell-cell communication of erosion macrophage as source with other cell types" 
										fig-cap="Figure: heatmap of cell-cell communication of stemness or differentiation as source with other cell types"}
![](images/xenium_ccc_heatmaps_cc_mean_target_erosion_macrophage.png){.align-center .lightbox width="900px" 
										fig_alt="heatmap of cell-cell communication of erosion macrophage as target with other cell types" 
										fig-cap="Figure: heatmap of cell-cell communication of stemness or differentiation as target with other cell types"}
...
pdf(glue("{fig_dir}/xenium_ccc_heatmaps_cc_mean_source_Epithelial_basal.pdf"), width = 12, height = 8)
print(p1)
dev.off()
png(glue("{fig_dir}/xenium_ccc_heatmaps_cc_mean_source_Epithelial_basal.png"), width = 12, height = 8, units = "in", res = 300)
print(p1)
dev.off()
...
```
![](images/xenium_ccc_heatmaps_cc_mean_source_Epithelial_basal.png){.align-center .lightbox width="900px" 
										fig_alt="heatmap of cell-cell communication of epithelial basal as source with other cell types" 
										fig-cap="Figure: heatmap of cell-cell communication of epithelial basal as source with other cell types"}
...
df <- df %>% select(case, Description, Count, p.adjust) %>% mutate(Description = str_replace(Description, " signaling pathway$", "")) %>%
...
results <- ls_vs_basal_cell_select$res
cases <- names(ls_vs_basal_cell_select$res)
for (case in cases){
  res <- results[[case]]
  res@result <- res@result %>%
    mutate(Description = str_replace(Description, " signaling pathway$", ""))
  p1 <- barplot(res, color = "p.adjust") + 
        scale_fill_gradientn(colors = rev(config_list$scale_7),
                             guide = guide_colorbar(reverse = TRUE)) +
        theme_classic()
  hight_set = nrow(res@result) * 0.5
  weight_set = max(4, hight_set * 1.2)
  ggsave(glue("{fig_dir}/xenium_kegg_Epithelial_subtype_vs_basal_call_{case}.pdf"), plot = p1,width = weight_set,height = hight_set)
  ggsave(glue("{fig_dir}/xenium_kegg_Epithelial_subtype_vs_basal_call_{case}.png"), plot = p1,width = weight_set,height = hight_set)
}


```

![](images/xenium_kegg_Epithelial_subtype_vs_basal_call_basal_EPCAM+.png){.align-center .lightbox width="900px" 
										fig_alt="kegg of Epithelial subtype basal_EPCAM+ versus basal_cell" 
                    fig-cap="Figure: kegg of Epithelial subtype basal_EPCAM+ versus basal_cell"}



# xenium KEGG Macrophage vs others 
```{r echo=TRUE, eval=FALSE}
ls_macrophage_select <- readRDS(glue("{rds_dir}/kegg_macrophage_cluster_marker_gene_total_select.rds"))
results <- ls_macrophage_select$res
cases <- names(results)
for (case in cases){
  res <- results[[case]]
  res@result <- res@result %>% mutate(Description = str_replace(Description, " signaling pathway$", ""))
  p1 <- barplot(res, color = "p.adjust") + 
        scale_fill_gradientn(colors = rev(config_list$scale_7),
                             guide = guide_colorbar(reverse = TRUE)) +
        theme_classic()
  hight_set = nrow(res@result) * 0.5
  weight_set = max(4, hight_set * 1.2)
  case <- ifelse(case == "MGC/TAM", "MGC_TAM", case)
  ggsave(glue("{fig_dir}/xenium_kegg_Macrophage_{case}.pdf"), plot = p1,width = weight_set,height = hight_set)
  ggsave(glue("{fig_dir}/xenium_kegg_Macrophage_{case}.png"), plot = p1,width = weight_set,height = hight_set)
}
