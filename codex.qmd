...
wkdir <- "/cluster/home/lixiyue_jh/projects/stomatology/analysis/lvjiong/human/meta/manuscript"
...
(glue("{fig_dir}/heatmap_celltype_freq.pdf")){fig_alt = "clustered heatmap with clinical info" width="900px" 
                                                    fig-cap="Figure: 1st round clustering" .align-center .lightbox}
(glue("{fig_dir}/stacked_bar_celltype_freq.pdf")){fig_alt = "stacked bar celltype freq" width="900px" 
                                                    fig-cap="Figure: 1st round clustering" .align-center .lightbox}
...
(glue("{fig_dir}/heatmap_celltype_cn_composition.pdf")){fig_alt = "heatmap with celltype CN composition" width="900px" 
                                                    fig-cap="Figure: 1st round clustering" .align-center .lightbox}
...
(glue("{fig_dir}/heatmap_subtype_cn_composition.pdf")){fig_alt = "heatmap with subtype CN composition" width="900px" 
                                                    fig-cap="Figure: 1st round clustering" .align-center .lightbox}
...
(glue("{fig_dir}/sample_cluster_heatmap_celltype_cn.pdf")){fig_alt = "heatmap with celltype sample cluster" width="900px" 
                                                    fig-cap="Figure: 1st round clustering" .align-center .lightbox}
...
(glue("{fig_dir}/sample_cluster_heatmap_subtype_cn_k10.pdf")){fig_alt = "heatmap with subtype sample cluster k10" width="900px" 
                                                    fig-cap="Figure: 1st round clustering" .align-center .lightbox}

(glue("{fig_dir}/sample_cluster_surv_curve_subtype_cn_cl5.pdf")){fig_alt = "surv curve with subtype sample cluster k10 cl5" width="900px" 
                                                    fig-cap="Figure: 1st round clustering" .align-center .lightbox}
...
(glue("{fig_dir}/surv_curve_pci_subtype_Macrophage_CD44+-Tumor_CD44+.pdf")){fig_alt = "surv curve pci subtype: Macrophage_CD44+-Tumor_CD44+" width="900px" 
                                                    fig-cap="Figure: 1st round clustering" .align-center .lightbox}
(glue("{fig_dir}/surv_curve_pci_subtype_CD4T_CD44+-Tumor_CD44+.pdf")){fig_alt = "surv curve pci subtype: CD4T_CD44+-Tumor_CD44+" width="900px" 
                                                    fig-cap="Figure: 1st round clustering" .align-center .lightbox}
(glue("{fig_dir}/surv_curve_pci_subtype_CD8T_CD44+-Tumor_CD44+.pdf")){fig_alt = "surv curve pci subtype: CD8T_CD44+-Tumor_CD44+" width="900px" 
                                                    fig-cap="Figure: 1st round clustering" .align-center .lightbox}
...
```
![](glue("{fig_dir}/voronoi_3-2-4_spatial_celltype_map.pdf")){fig_alt = "voronoi 3-2-4 spatial celltype" width="900px" 
                                                    fig-cap="Figure: 1st round clustering" .align-center .lightbox}
![](glue("{fig_dir}/voronoi_3-4-3_spatial_celltype_map.pdf")){fig_alt = "voronoi 3-4-3 spatial celltype" width="900px" 
                                                    fig-cap="Figure: 1st round clustering" .align-center .lightbox}
![](glue("{fig_dir}/voronoi_3-5-4_spatial_celltype_map.pdf")){fig_alt = "voronoi 3-5-4 spatial celltype" width="900px" 
                                                    fig-cap="Figure: 1st round clustering" .align-center .lightbox}
...
```
(glue("{fig_dir}/voronoi_3-2-4_spatial_subtype_cn_top_map.pdf")){fig_alt = "voronoi 3-2-4 spatial subtype cn top" width="900px" 
                                                    fig-cap="Figure: 1st round clustering" .align-center .lightbox}
