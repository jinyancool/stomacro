...
dat_dir <- "/cluster/home/lixiyue_jh/projects/stomatology/analysis/lvjiong/human/meta/manuscript"
...
![](images/heatmap_celltype_freq.png){.align-center .lightbox width="900px" 
										fig_alt="clustered heatmap with clinical info" 
                                        fig-cap="Figure: heatmap of samples' celltype frequency with clinical information"}
![](images/stacked_bar_celltype_freq.png){.align-center .lightbox width="900px" 
										fig_alt="stacked bar celltype freq" 
										fig-cap="Figure: stacked barplot of samples' celltype frequency without clinical information"}
...
![](images/heatmap_celltype_cn_composition.png){.align-center .lightbox width="900px"
												fig_alt="heatmap with celltype CN composition" fig-cap="Figure: CN's celltype composition"}
...
![](images/heatmap_subtype_cn_composition.png){.align-center .lightbox width="900px" 
											fig_alt="heatmap with subtype CN composition" fig-cap="Figure: CN's sub celltype composition"}
...
![](images/sample_cluster_heatmap_celltype_cn.png){.align-center .lightbox width="900px" 
	fig_alt="heatmap of sample cluster by celltype CN" fig-cap="Figure: heatmap of sample cluster by celltype CN"}
...
ggsave(glue("{fig_dir}/sample_cluster_surv_curve_subtype_cn_cl{i}.pdf"), p, width = 6, height = 8)
...
![](images/sample_cluster_heatmap_subtype_cn_k10.png){.align-center .lightbox width="900px" 
	fig_alt="heatmap of sample cluster by subtype CN" fig-cap="Figure: heatmap of sample cluster by subtype CN"}

![](images/sample_cluster_surv_curve_subtype_cn_cl5.png){.align-center .lightbox width="900px" 
	fig_alt="surv curve of subtype CN cluster5 vs others" fig-cap="Figure: surv curve of subtype CN cluster5 vs others"}
...
for(pair in pair2){
  ...
  p <- arrange_ggsurvplots(list(p), ncol = 1, print = FALSE)
  ggsave(glue("{fig_dir}/surv_curve_pci_subtype_{pair}.pdf"), p, width = 6, height = 8)
  pair_fig[pair] <- p
}


p1 <- pair_fig["Macrophage_CD44+-Tumor_CD44+"]
p2 <- pair_fig["CD4T_CD44+-Tumor_CD44+"]
...
![](images/surv_curve_pci_subtype_Macrophage_CD44+-Tumor_CD44+.png){.align-center .lightbox width="900px" 
													fig_alt="surv curve pci subtype: Macrophage_CD44+-Tumor_CD44+"
                                                    fig-cap="Figure: surv curve pci subtype: Macrophage_CD44+-Tumor_CD44+"}
![](images/surv_curve_pci_subtype_CD4T_CD44+-Tumor_CD44+.png){.align-center .lightbox width="900px" 
													fig_alt="surv curve pci subtype: CD4T_CD44+-Tumor_CD44+" 
                                                    fig-cap="Figure: surv curve pci subtype: Macrophage_CD44+-Tumor_CD44+"}
![](images/surv_curve_pci_subtype_CD8T_CD44+-Tumor_CD44+.png){.align-center .lightbox width="900px" 
													fig_alt="surv curve pci subtype: CD8T_CD44+-Tumor_CD44+" 
                                                    fig-cap="Figure: surv curve pci subtype: CD8T_CD44+-Tumor_CD44+"}
...
![](images/voronoi_3-2-4_spatial_celltype_map.png){.align-center .lightbox width="900px" 
													fig_alt="voronoi 3-2-4 spatial celltype"
                                                    fig-cap="Figure: voronoi 3-2-4 spatial celltype"}
![](images/voronoi_3-4-3_spatial_celltype_map.png){.align-center .lightbox width="900px"
													fig_alt="voronoi 3-4-3 spatial celltype"
                                                    fig-cap="Figure: voronoi 3-4-3 spatial celltype"}
![](images/voronoi_3-5-4_spatial_celltype_map.png){.align-center .lightbox width="900px" 
													fig_alt="voronoi 3-5-4 spatial celltype" 
                                                    fig-cap="Figure: voronoi 3-5-4 spatial celltype"}
...
![](images/voronoi_3-2-4_spatial_subtype_cn_top_map.png){.align-center .lightbox width="900px" 
												fig_alt="voronoi 3-2-4 spatial subtype cn top"
                                                fig-cap="Figure: voronoi 3-2-4 spatial subtype cn(top)"}
