...
p <- DoHeatmap(srt_sub, slot = "scale.data", assay = "CODEX", features = markers_10, raster = TRUE,
              group.colors = config_list$cell_type, angle = 90, size = 4, disp.min = -2.5, disp.max = 2.5) +
              NoLegend()
ggsave(glue("{fig_dir}/heatmap_celltype_markers_10_200cell.pdf"), p, dpi=800, width = 8, height = 6)
ggsave(glue("{fig_dir}/heatmap_celltype_markers_10_200cell.png"), p, dpi=800, width = 8, height = 6)
...
## (j) pci & cor: heatmap of subtype pci and cor
